...
- **Trò chuyện về manga/anime** với kiến thức chuyên sâu qua RAG pipeline
...
| `comic_expert_agent` | comic_knowledge | RAG truy xuất kiến thức manga/anime | P0 |
...
| Anime Bibliotherapy | Recommend manga/anime phù hợp tâm trạng | P1 |
...
| 3 | `comic_knowledge` | Comic | Hỏi kiến thức manga/anime | `comic_expert_agent` |
